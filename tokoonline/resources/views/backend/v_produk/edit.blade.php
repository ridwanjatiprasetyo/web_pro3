                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nama_produk" value="{{ old('nama_produk', $edit->nama_produk) }}" class="form-control @error('nama_produk') is-invalid @enderror"
                                    ...
                                    <div class="form-group">
                                        ...
                                        @error('detail')
                                            <span class="invalid-feedback alert-danger" role="alert"></span>
                                            {{ $message }}
                                            </span>
                                        @enderror
                                    </div>
